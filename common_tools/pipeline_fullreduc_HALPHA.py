...
top_output_reducimage='./CTIODataJune2017_reduced_HALPHA_v2'
...
master_flat_file=top_datapath+'../'+'Flats_et_bias/FinalMasterFlat_CTIO_HALPHA.fits'
...
if __name__ == '__main__':
    ...
    print 'master bias : ',master_bias_file
    print 'master flat file :',master_flat_file
