...
def ProcessSimulationwthaer(airmass_num,pwv_num,oz_num,press_num,aer_num):    
...
if __name__ == "__main__":
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:],"hz:w:o:p:a:",["z=","w=","o=","p=","a="])
    except getopt.GetoptError:
        print ' Exception bad getopt with :: '+sys.argv[0]+ ' -z <airmass> -w <pwv> -o <oz> -p <pr> -a <aer>'
        print ' - pwv in kg / m2 or mm '
        print ' - oz in DbU '
        print ' - P in hPa '
        print ' - aerosols in percent '
        sys.exit(2)
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            print 'Do not understand arguments : ',arg
    ...
    if aer_nb<0 or aer_nb >1.00 :
        print "bad Aerosols value pr=",aer_nb
        sys.exit()
    ...
    path, outputfile=ProcessSimulationwthaer(airmass_nb,pwv_nb,oz_nb,pr_nb,aer_nb)
